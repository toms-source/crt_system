<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4 relative">
            ...
            <div class="relative">
                <!-- Password Input -->
                <x-text-input id="password" class="block mt-1 w-full pr-12 text-gray-900 border rounded-lg"
                            type="password"
                            name="password"
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button id="submitButton" class="ms-3 opacity-50 cursor-not-allowed" disabled>
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
...
<script src="{{ asset('js/disabledbutton.js') }}"></script> <!-- Link to the external JS file -->
