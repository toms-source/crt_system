...
<script>
        function togglePassword() {
            let CurrentPasswordInput = document.getElementById('update_password_current_password');
            let newPasswordInput = document.getElementById('update_password_password');
            let ConfirmPasswordInput = document.getElementById('update_password_password_confirmation');
            let checkbox = document.getElementById('show-password');

            CurrentPasswordInput.type = checkbox.checked ? "text" : "password";
