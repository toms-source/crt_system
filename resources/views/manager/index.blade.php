                    ...
                    <section>
                        <div x-data="{ tab: 'tab1' }" class="w-full mx-auto">
                            ...
                            <div class="flex border-b border-gray-200 dark:border-stone-700">
                                <template x-for="(label, index) in ['Users RTO List', 'RTO History', 'Tab 3']" :key="index">
                                    <button
                                    ...
                                    <div class="">
                                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                            <div class="bg-white dark:bg-stone-800 shadow overflow-hidden sm:rounded-lg">
                                                <table id="inventory-table" class="min-w-full divide-y divide-stone-200 dark:divide-stone-700">
